...
layout(location = 9) in vec4 InstanceNormal0;
layout(location = 10) in vec4 InstanceNormal1;
layout(location = 11) in vec4 InstanceNormal2;
layout(location = 12) in vec4 InstanceColor;
layout(location = 13) in ivec4 InstanceLightOverlay;
layout(location = 14) in vec4 InstanceUvTransform0;
layout(location = 15) in vec2 InstanceUvTransform1;
...
int signed16(int value) { return (value << 16) >> 16; }
...
#else
    ivec2 light = ivec2(signed16(InstanceLightOverlay.x), signed16(InstanceLightOverlay.x >> 16));
    ivec2 overlay = ivec2(signed16(InstanceLightOverlay.y), signed16(InstanceLightOverlay.y >> 16));
