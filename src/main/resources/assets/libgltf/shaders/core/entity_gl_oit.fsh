...
layout(binding = 3) uniform sampler2D DepthBoundsSampler;
layout(binding = 4) uniform sampler2D Coeff0;
#if COEFF_COUNT > 4
layout(binding = 5) uniform sampler2D Coeff1;
#endif
...
#if defined(OIT_DEPTH_BOUNDS) || defined(OIT_ACCUMULATE)
